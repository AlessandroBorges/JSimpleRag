...
/**
 * Enum representing the type of embedding stored in the system.
 * Maps to PostgreSQL enum tipo_embedding ('documento', 'capitulo', 'trecho')
 */
